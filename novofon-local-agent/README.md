...
вставьте утверждённый текст с тегами `[я]` и `[Клиент]`, прослушайте локальное
аудио и укажите начало/конец каждой реплики в миллисекундах. До утверждения
проверяются все роли, порядок и отсутствие пересечений, а также границы
реальной длительности аудио. Исходный ASR-транскрипт остаётся отдельным
